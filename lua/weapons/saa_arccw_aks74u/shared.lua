...
SWEP.RangeMin = 10
SWEP.RangeMax = 12000*(260/305)
SWEP.ArmorPiercing = 0.75
SWEP.Penetration = 6
SWEP.DamageType = DMG_BULLET
SWEP.ShootEntity = nil
SWEP.PhysBulletMuzzleVelocity = (730/715)*28150 -- Physical bullet muzzle velocity in Hammer Units/second. 1 HU != 1 inch.
...
SWEP.ShootSound = "saa/krinky/aks_fp.wav"
--{
...
--}
SWEP.ShootSoundIndoor = "saa/krinky/aks_fp.wav" --{
--    basesh .. "ak74_loop_stereo_default_initial_01.wav",
--    basesh .. "ak74_loop_stereo_default_initial_02.wav",
--    basesh .. "ak74_loop_stereo_default_initial_03.wav",
--    basesh .. "ak74_loop_stereo_default_initial_04.wav",
...
SWEP.LayerSound = "saa/ak74_2502/ak74_tail.wav"
...
SWEP.DefaultBodygroups = "0000000011"
...
name = "AKS-74U"
    local attached = self:GetElements()
    if attached["akmn_dovetail"] then name = "AKS-74UN"
    else name = "AKS-74U"
    end
